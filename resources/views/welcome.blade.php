...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased dark:bg-black dark:text-white/50 " >
        <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50" style="height: auto;">
            <img id="background" class="absolute -left-20 top-0 max-w-[877px]" src="https://laravel.com/assets/img/welcome/background.svg" alt="Laravel background" />
            <div class=" relative  flex flex-col items-center justify-center selection:bg-[#52c4c4] selection:text-white" style="height: auto;">
                <div class=" relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header  class="block grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2">
                            <h2  style="font-size: 35px; margin-top: 0; "><a style="color: gray" href="#">DS HMS</a></h2>
                        ...
                        @if (Route::has('login'))
                            <nav class="-mx-3 flex flex-1 justify-end">
                                ...
                                @else
                                    <a
                                        href="{{ route('login') }}"
                                        class="rounded-md px-5 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white" style="font-size: 18px; font-weight: bold;"
                                    >
                                        Log in
                                    </a>
                                    ...
                                    @if (Route::has('register'))
                                        <a
                                            href="{{ route('register') }}"
                                            class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white" style="font-size: 18px; font-weight: bold;"
                                        >
                                            Register
                                        </a>
                                    @endif
                    ...
                    <div class=" main">
                        <div style="width: 100%; height: 75vh; background-color: gray; border-radius: 20px; " >
                            <img  style="width: 100%; height: 75vh; border-radius: 20px; box-shadow: 0 0 35px  rgb(163, 163, 163);" src="images/hospital_img1.jpg" alt="">
                        </div>
                    ...
                    <div class="block py-16">
                        ...
                        <div class="py-16 d-flex w-100" style="width: 100%;">
                            <div class="w-30" style="background-color: rgba(211, 210, 210, 0.381); width: 30%; height: auto;">
                                <img style="padding: 20px; margin-top: 30px;" src="images/hospital1.jpg" alt="">
                            </div>

                            <div class="w-70" style="background-color: rgb(20, 129, 44); width: 70%; height: auto;">
                                <h2 style="font-weight: bold; padding: 20px; font-size: 23px; text-align: center; color: #e5e7ebd5;">Welcome to DS HMS – Revolutionizing Healthcare Management</h2>
                                <p style="padding: 20px; font-size: 20px; text-align: center; color: #e5e7ebc1;">At DS HMS, we are dedicated to transforming healthcare systems through innovative technology and intelligent solutions. Our Hospital Management System (HMS) is designed to simplify and optimize the daily operations of hospitals, clinics, and healthcare facilities, improving patient care and streamlining administrative tasks.<br><br>

                                    With the constant evolution of the healthcare industry, we understand the challenges faced by healthcare professionals and administrators in managing patient information, appointments, treatments, and billing. That's why we have created DS HMS—to offer an efficient, comprehensive, and easy-to-use platform that automates and integrates essential processes within the healthcare system.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="block py-7" >
                        <h2 style="font-size: 30px; text-align: center; ">Our mission</h2>

                        <div  style="display: flex; justify-content: center; align-items: center; margin-top: 80px; background-color: rgb(239, 239, 239); box-shadow: 0 0 10px 5px rgb(255, 255, 255);">

                            <div class="py-16 d-flex w-100" style="width: 100%;">
                                <div class="w-30" style="background-color: ; width: 50%; height: auto;padding-left: 60px;" >
                                    <img style="border: 2px solid black; width: 350px; height: 350px; border-radius: 50%; " src="images/our mission.jpg" alt="">
                                </div>
    
                                <div class="w-70" style="background-color: ; width: 70%; height: auto;">
                                    <h2 style=" padding: 20px; margin-top: 60px; font-size: 23px; text-align: center; color: #040404d5;">our mission is to empower healthcare providers with a robust, user-friendly, and efficient software solution that helps them manage every aspect of their healthcare practice. Whether it's patient registration, appointment scheduling, medical record management, billing, or reporting, DS HMS integrates all of these critical operations into one comprehensive platform.</p>
                                </div>
                            </div>
                        </div>
                    </div><br><br><br>
                    ...
                    <div class="block">
                        <h2  style="font-size: 30px; text-align: center; ">Our Services</h2>
                        <div style="width: 100%; height: auto; display: flex; justify-content: center; margin-bottom: 30px; gap: 15px; text-align: center;  margin-top: 40px;">
                            <div  style="width: 25%; height: auto; border: 1px solid black;">
                                <h3 class="py-4" style="font-weight: bold;">Patient Management</h3>
                                <ul style="text-align:left; padding: 20px;">
                                    <li><span style="color: red">*</span> Simplified patient registration and record keeping.</li>
                                    <li><span style="color: red">*</span> Easy appointment scheduling and reminders.</li>
                                    <li><span style="color: red">*</span> Quick access to medical history.</li>
                                </ul>
                            </div>
                            <div style="width: 25%; height: auto; border: 1px solid black;">
                                <h3 class="py-4" style="font-weight: bold;">Inventory & Pharmacy Management</h3>
                                <ul style="text-align:left; padding: 20px;">
                                    <li><span style="color: red">*</span> Track medical supplies and inventory.</li>
                                    <li><span style="color: red">*</span> Integrated pharmacy management.</li>
                                    <li><span style="color: red">*</span> Alerts for low stock and expirations.</li>
                                </ul>
                            </div>
                            <div style="width: 25%; height: auto; border: 1px solid black;">
                                <h3 class="py-4" style="font-weight: bold;">Laboratory & Test Management</h3>
                                <ul style="text-align:left; padding: 20px;">
                                    <li><span style="color: red; ">*</span> Schedule and manage diagnostic tests.</li>
                                    <li><span style="color: red">*</span> Access test results quickly.</li>
                                    <li><span style="color: red">*</span> Generate lab reports and analytics.</li>
                                </ul>
                            </div>
                            <div style="width: 25%; height: auto; border: 1px solid black;">
                                <h3 class="py-4" style="font-weight: bold;">Reporting & Analytics</h3>
                                <ul style="text-align:left; padding: 20px;">
                                    <li><span style="color: red;">*</span> Customizable performance reports.</li>
                                    <li><span style="color: red">*</span> Data analytics for improved efficiency.</li>
                                    <li><span style="color: red">*</span> Real-time dashboard visualizations.</li>
                                </ul>
                            </div>
                            {{-- <div style="width: 25%; height: auto;">5</div>
                            <div style="width: 25%; height: auto;">6</div> --}}
                        </div>
                    </div>
